...
year <- 2019
years <- c(1986,1990,2000,2010,2019)
...
for(year in years){
  ...
  if(allocation=="mass") L <- readRDS(file=paste0("/mnt/nfs_fineprint/tmp/fabio/v1.2/losses/",year,"_L_mass.rds"))
...
data.table::fwrite(results, file=paste0("./output/FABIO_v1.2_land_results_",country,".csv"), sep=",")
